...
//! holds any [`KvStore`] and turns a validated [`Command`] into the matching store
//! call. Keeping it generic lets the conformance suite drive the same command flow
//! against a real store or an in-memory fake.
